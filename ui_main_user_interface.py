...
class Ui_main_window(object):
    def setupUi(self, main_window):
        ...
        self.function_display_groupBox.setGeometry(QRect(20, 460, 191, 121))
        ...
        self.infection_parameters_groupBox.setGeometry(QRect(20, 240, 191, 131))
        self.layoutWidget4 = QWidget(self.infection_parameters_groupBox)
        self.layoutWidget4.setObjectName(u"layoutWidget4")
        self.layoutWidget4.setGeometry(QRect(10, 30, 171, 94))
        self.infection_params_layout = QHBoxLayout(self.layoutWidget4)
        ...
        self.vitality_rate_label = QLabel(self.layoutWidget4)
        ...
        self.vitality_rate_dSpinBox = QDoubleSpinBox(self.layoutWidget4)
