...
class Ui_main_window(object):
    def setupUi(self, main_window):
        ...
        self.plotting_widget.setGeometry(QRect(240, 10, 821, 741))
        ...
        self.dynamics_graph.setGeometry(QRect(10, 10, 801, 691))
        ...
        self.phase_graph.setGeometry(QRect(10, 10, 801, 691))
        ...
        self.sir_classic_label.setGeometry(QRect(10, 40, 221, 121))
        ...
        self.function_display_groupBox.setGeometry(QRect(10, 560, 221, 121))
        self.layoutWidget = QWidget(self.function_display_groupBox)
        self.layoutWidget.setObjectName(u"layoutWidget")
        self.layoutWidget.setGeometry(QRect(10, 30, 96, 83))
        ...
        self.population_checkBox = QCheckBox(self.function_display_groupBox)
        self.population_checkBox.setObjectName(u"population_checkBox")
        self.population_checkBox.setGeometry(QRect(110, 30, 90, 23))
        self.sirsum_test_checkbox = QCheckBox(self.function_display_groupBox)
        self.sirsum_test_checkbox.setObjectName(u"sirsum_test_checkbox")
        self.sirsum_test_checkbox.setGeometry(QRect(110, 60, 90, 23))
        self.layoutWidget1 = QWidget(self.central_widget)
        self.layoutWidget1.setObjectName(u"layoutWidget1")
        self.layoutWidget1.setGeometry(QRect(10, 690, 221, 58))
        ...
        self.observation_time_groupBox.setGeometry(QRect(10, 460, 221, 71))
        self.layoutWidget2 = QWidget(self.observation_time_groupBox)
        self.layoutWidget2.setObjectName(u"layoutWidget2")
        self.layoutWidget2.setGeometry(QRect(9, 30, 198, 28))
        ...
        self.poluation_groupBox.setGeometry(QRect(10, 160, 221, 101))
        self.layoutWidget3 = QWidget(self.poluation_groupBox)
        self.layoutWidget3.setObjectName(u"layoutWidget3")
        self.layoutWidget3.setGeometry(QRect(10, 30, 204, 62))
        ...
        self.infection_parameters_groupBox.setGeometry(QRect(10, 260, 221, 101))
        self.layoutWidget4 = QWidget(self.infection_parameters_groupBox)
        self.layoutWidget4.setObjectName(u"layoutWidget4")
        self.layoutWidget4.setGeometry(QRect(10, 30, 201, 61))
        self.inf_parameters_layout = QHBoxLayout(self.layoutWidget4)
        self.inf_parameters_layout.setObjectName(u"inf_parameters_layout")
        self.inf_parameters_layout.setContentsMargins(0, 0, 0, 0)
        ...
        self.inf_parameters_layout.addLayout(self.inf_param_label_layout)
        ...
        self.inf_parameters_layout.addLayout(self.inf_param_dspinBox_layout)
        ...
        self.basic_reproduction_number_label.setGeometry(QRect(10, 530, 221, 31))
        ...
        self.sir_vitality_label.setGeometry(QRect(10, 40, 221, 121))
        ...
        self.pop_dynamics_groupBox = QGroupBox(self.central_widget)
        self.pop_dynamics_groupBox.setObjectName(u"pop_dynamics_groupBox")
        self.pop_dynamics_groupBox.setGeometry(QRect(10, 360, 221, 101))
        self.widget = QWidget(self.pop_dynamics_groupBox)
        self.widget.setObjectName(u"widget")
        self.widget.setGeometry(QRect(10, 30, 201, 64))
        self.pop_dynamics_layout = QVBoxLayout(self.widget)
        self.pop_dynamics_layout.setObjectName(u"pop_dynamics_layout")
        self.pop_dynamics_layout.setContentsMargins(0, 0, 0, 0)
        self.mortality_rate_layout = QHBoxLayout()
        self.mortality_rate_layout.setSpacing(6)
        self.mortality_rate_layout.setObjectName(u"mortality_rate_layout")
        self.mortality_rate_label = QLabel(self.widget)
        ...
        self.mortality_rate_layout.addWidget(self.mortality_rate_label)

        self.mortality_rate_dSpinBox = QDoubleSpinBox(self.widget)
        ...
        self.mortality_rate_dSpinBox.setDecimals(3)
        self.mortality_rate_dSpinBox.setSingleStep(0.001000000000000)
        self.mortality_rate_dSpinBox.setValue(0.004000000000000)

        self.mortality_rate_layout.addWidget(self.mortality_rate_dSpinBox)


        self.pop_dynamics_layout.addLayout(self.mortality_rate_layout)

        self.total_births_layout = QHBoxLayout()
        self.total_births_layout.setObjectName(u"total_births_layout")
        self.total_births_label = QLabel(self.widget)
        self.total_births_label.setObjectName(u"total_births_label")

        self.total_births_layout.addWidget(self.total_births_label)

        self.total_births_spinBox = QSpinBox(self.widget)
        self.total_births_spinBox.setObjectName(u"total_births_spinBox")
        self.total_births_spinBox.setMaximum(9999999)
        self.total_births_spinBox.setSingleStep(100)
        self.total_births_spinBox.setValue(5000)

        self.total_births_layout.addWidget(self.total_births_spinBox)


        self.pop_dynamics_layout.addLayout(self.total_births_layout)

        self.model_on_display_label = QLabel(self.central_widget)
        self.model_on_display_label.setObjectName(u"model_on_display_label")
        self.model_on_display_label.setGeometry(QRect(10, 16, 221, 21))
    ...
    def retranslateUi(self, main_window):
        ...
        self.population_checkBox.setText(QCoreApplication.translate("main_window", u"Population", None))
        self.sirsum_test_checkbox.setText(QCoreApplication.translate("main_window", u"S+I+R", None))
#if QT_CONFIG(statustip)
        ...
        self.poluation_groupBox.setTitle(QCoreApplication.translate("main_window", u"Initial parameters", None))
#if QT_CONFIG(statustip)
        ...
        self.pop_dynamics_groupBox.setTitle(QCoreApplication.translate("main_window", u"Population dynamics parameters", None))
#if QT_CONFIG(statustip)
        ...
        self.model_on_display_label.setText(QCoreApplication.translate("main_window", u"Model: Classic SIR", None))
